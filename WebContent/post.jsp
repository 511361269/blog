...
<head>
    ...
    <title>${sessionScope.articleEx.title }</title>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                    <div class="post-heading">
                        <h1>${sessionScope.articleEx.title }</h1>
                        <h2 class="subheading">${sessionScope.articleEx.info}</h2>
                        <span class="meta">Posted by <a href="about.html">${sessionScope.articleEx.admin.username }</a> on ${sessionScope.articleEx.adTime}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <article>
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                   <p>
                   	${sessionScope.articleEx.content}
                   </p>
                </div>
            </div>
        </div>
